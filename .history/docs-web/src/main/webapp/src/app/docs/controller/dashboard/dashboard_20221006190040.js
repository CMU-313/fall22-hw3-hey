angular.module('docs').controller('Dashboard', function () {
    ...
    dashboard.stats = dashboard.stats = { averageGPA: 0, commonSkills: ["Python", "C", "Leadership"] };
    ...
    Restangular.one('applicant').put({
        name: dashboard.applicants[0]['name'],
        GPA: dashboard.applicants[0]['GPA'],
        skills: dashboard.applicants[0]['skills'],
        other: dashboard.applicants[0]['other']
    }).then(function (data) {
